...
namespace xWAREActivity.Controllers.Web
{
    ...
    public class LikeWebController : ApiController
    {
        ...
        public LikeWebController(IUserRepository userRepository, ILikeRepository likeRepository, IPostRepository postRepository)
        {
        ...
        [Route("admin/post/{id}/like/{likeid}")]
        [HttpDelete]
