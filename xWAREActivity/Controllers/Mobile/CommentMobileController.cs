...
namespace xWAREActivity.Controllers.Mobile
{
    ...
    public class CommentMobileController : ApiController
    {
        private ICommentRepository commentRepository;
        private IPostRepository postRepository;

        public CommentMobileController()
        {
        ...
        public CommentMobileController(ICommentRepository commentRepository,IPostRepository postRepository)
        {
        ...
        [Route("api/post/{postid}/comment/{id}")]
        [HttpGet]
