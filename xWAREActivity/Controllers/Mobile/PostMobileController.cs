...
namespace xWAREActivity.Controllers.Mobile
{
   // [Authorize(Roles = "Admin, User")]
    public class PostMobileController : ApiController
    {
        private IPostRepository postRepository;
        private IUserRepository userRepository;
        private ILikeRepository likeRepository;

        public PostMobileController()
        {
        ...
        public PostMobileController(IUserRepository userRepository, ILikeRepository likeRepository, IPostRepository postRepository)
        {
